export const cn = "https://cn-stage.test.dataone.org"
export const base_url = cn + "/cn/v2/"
export const portal_path = "/portal/oauth?action=start&target="
export const default_query = () => {
  return {
    ...
    "fl": "id,title,origin,pubDate,publisher,isPublic,datasource",
